...
const Home = () => {
  ...
  return (
    <div className="pt-24 bg-gray-900 min-h-screen overflow-hidden">
      ...
      <motion.div
        ...
        className="px-6 sm:px-12 py-14 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10"
      >

        <Card
          variants={cardVariant}
          title="Directory"
          description="Explore nearby shops, services, salons, and more."
        ...
        <Card
          variants={cardVariant}
          title="Market"
          description="Find local markets for produce, clothing & daily needs."
        ...
        <Card
          variants={cardVariant}
          title="Food"
          description="Find the best restaurants, cafes & food stalls near you."
        ...
        <Card
          variants={cardVariant}
          title="Groceries"
          description="Get groceries & essentials from trusted stores nearby."
...
const Card = ({ title, description, buttonText, onClick, variants }) => {
  return (
    <motion.div
      variants={variants}
      className="
        relative h-64 sm:h-72 rounded-3xl overflow-hidden group cursor-pointer
    ...
    >
      ...
      <div className="relative z-10 p-8 flex flex-col justify-end h-full">
        ...
        <h2 className="text-white text-3xl font-bold drop-shadow-lg mb-2">
          {title}
        </h2>

        {/* Show description only on hover */}
        <p className="text-gray-200 text-sm opacity-0 group-hover:opacity-100 transition-all duration-500 mb-4 leading-relaxed max-w-xs">
          {description}
        </p>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.94 }}
          className="
            bg-white/20 backdrop-blur-md text-white px-6 py-2 rounded-full
            border border-white/30 transition-all font-medium
          "
        >
          {buttonText} →
        </motion.button>
      ...
      {/* NEON HOVER BORDER */}
      <motion.div
        className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-blue-400/70 transition-all duration-500"
      />
    </motion.div>
  );
};
